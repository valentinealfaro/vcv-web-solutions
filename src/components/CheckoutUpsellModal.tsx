...
export const ADDONS: Addon[] = [
  {
    id: 'nova-receptionist',
    title: 'Nova AI Receptionist',
    priceCents: 14700,
    priceLabel: '+$147/mo',
    desc: '24/7 AI answers every call, captures leads, books appointments, and texts you instantly. Never miss a job again.',
    color: '#10b981',
    contexts: ['website', 'bundle'],
  },
  {
    id: 'extra-volume',
