...
export const ADDONS: Addon[] = [
  {
    ...
    priceCents: 5000,
    priceLabel: '+$50/mo',
    desc: 'For high-traffic businesses pushing past included call minutes.',
    color: '#3b82f6',
  ...
  },
  {
    ...
    priceCents: 30000,
    priceLabel: '+$300/mo',
    desc: 'Pro pay-per-click campaigns we run for you (low end of $300–$1,000 range).',
    color: '#10b981',
    contexts: ['nova', 'website', 'bundle'],
  },
  {
    ...
    priceCents: 50000,
    priceLabel: '+$500 once',
    desc: 'Niche-targeted landing pages that rank for local searches.',
    color: '#f97316',
    contexts: ['nova', 'website', 'bundle'],
  },
];
