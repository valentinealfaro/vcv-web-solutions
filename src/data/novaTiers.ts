/* ─── Single source of truth for Nova pricing tiers ─────────────
   ...
   Setup fee ($147) is the same for both billing periods.
─────────────────────────────────────────────────────────────────── */
...
export const NOVA_TIERS: NovaTier[] = [
  {
    ...
    price: 77, priceCents: 7700,
    priceAnnual: 770, priceCentsAnnual: 77000, annualSavings: 154,
  ...
  },
  {
    ...
    price: 247, priceCents: 24700,
    priceAnnual: 2470, priceCentsAnnual: 247000, annualSavings: 494,
...
export const NOVA_SETUP_FEE_CENTS = 14700;   // $147, same on monthly + annual
export const NOVA_SETUP_FEE_LABEL = 'One-Time Setup Fee ($147)';
